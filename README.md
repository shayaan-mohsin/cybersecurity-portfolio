...
Cybersecurity portfolio focused on Governance, Risk, and Compliance (GRC), cyber risk, Cyber Threat Intelligence (CTI), vulnerability prioritization, privacy, and security strategy.

This repository brings together three public-source cybersecurity projects. Each project is written as an analyst deliverable: clear question, evidence base, findings, risk interpretation, and executive-facing recommendations.

## How To Read This Portfolio

Start with the project summaries below, then open the project that best matches the skill area you want to evaluate. Each project includes a short reader guide, visual snapshot, methodology notes, deeper analysis, and an executive summary.

| Reading path | Best for reviewing |
|---|---|
| Project README | Fast overview of the question, evidence, findings, visuals, and deliverables |
| Methodology or source notes | How the public data or advisory sources were collected and bounded |
...
- Translating public security evidence into practical risk decisions
- Using frameworks such as NIST CSF 2.0 and MITRE ATT&CK without overclaiming compliance or attribution
- Building repeatable workflows for vulnerability prioritization and executive reporting
...
- Using Python to analyze public datasets and generate repeatable outputs
...
Portfolio V1 is complete. The repository includes three evidence-backed cybersecurity projects, sprint/project-management artifacts, public-source data or advisory references, Python-generated visual summaries, executive summaries, and a final public-content review.
